...
# Предупреждение!!!!!!!!!! Эта версия плагина больше не поддерживаеться потому что была улучшенная версия плагина на [сайта](https://alfheimguide.ct.ws/plugins?plugin_id=12). Это ознакомительная версия о том что плагины безопасны.
